...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/cuistorefront/electronics/en",
						"https://electronics.local:9002/cuistorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/cuistorefront/electronics/en",
						"https://electronics.local:9002/cuistorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/cuistorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/cuistorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/cuistorefront/electronics/en",
						"https://electronics.local:9002/cuistorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/cuistorefront",
						"https://electronics.local:9002/cuistorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/cuistorefront",
						"https://electronics.local:9002/cuistorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/cuistorefront/electronics/en",
						"https://electronics.local:9002/cuistorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
