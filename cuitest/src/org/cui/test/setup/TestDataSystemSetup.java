...
import org.cui.test.constants.CuiTestConstants;
import org.cui.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = CuiTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/cuitest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/cuitest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/cuitest/import/cstickets.impex");
			...
			importImpexFile(context, "/cuitest/import/csquotes.impex");
		}
	}
}
