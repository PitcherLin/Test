 ...
 */
package org.cui.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(CuiFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(CuiFulfilmentProcessConstants.PARENT_PROCESS);
