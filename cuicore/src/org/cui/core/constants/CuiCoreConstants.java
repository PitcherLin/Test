 ...
 */
package org.cui.core.constants;

/**
 * Global class for all CuiCore constants. You can add global constants for your extension into this class.
 */
public final class CuiCoreConstants extends GeneratedCuiCoreConstants
{
	public static final String EXTENSIONNAME = "cuicore";


	private CuiCoreConstants()
	{
		//empty
	}
